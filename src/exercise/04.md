...
We learned about managed states which are states we're explicitly managing & derived states which are states calculated based on other states. We learned why mutation in react managed states could be a problem (closure).
