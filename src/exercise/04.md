...
We learned about managed states which are states we're explicitly managing & derived states which are states calculated based on other states. We learned why mutation of the states in react could be a problem (closure).
